...
export async function registerUser(env, body, meta) {
...
export async function loginUser(env, body, meta) {
...
async function createSession(env, userId, meta) {
...
export async function refreshSession(env, refreshToken, meta) {
...
export async function logoutSession(refreshToken, userId) {
    const hash = hashRefreshToken(refreshToken);
